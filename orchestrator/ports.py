...
DeliveryStore, the adapters.deploy module), so the core imported the
...
class Deployer(Protocol):
    """The traffic-shift half of deploying: promote a tagged revision to
    100%. (Building + tagging a preprod revision is the preprod_ci
    step's own business, sdlc_steps/preprod_ci.)"""
