"""Entry points and the ONE composition root.
  ...
  webhook.py         POST /webhooks/github on the resident services: HMAC-
                     verified GitHub deliveries become the same nudge the
                     heartbeat produces (gate comments, new PR heads)
