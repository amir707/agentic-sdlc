"""Entry point: python -m sdlc.app.release --project <name>
...
(→ Pub/Sub → the ADK ambient-trigger endpoint, sdlc/adapters/adk/apps/release_app.py)
...
def main() -> None:
    ...
    from sdlc.release.flow import run_release_pass
