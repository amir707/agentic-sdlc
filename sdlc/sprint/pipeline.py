...
(sdlc/adapters/adk/item_workflow.py, ADR-0007). What that graph carries between
...
from sdlc.definition import Route  # noqa: F401 (re-exported: the graph's vocabulary)
